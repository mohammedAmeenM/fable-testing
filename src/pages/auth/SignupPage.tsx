  ...
  const handleSubmit = async (
    ...
    try {
      ...
      if (response.data.data.accessToken || response.data.data.id) {
        ...
        dispatch(
          signupSuccess({ userId: response.data.data.id, email: values.email })
        );
        setStatus({
          type: "success",
        ...
        <div className="p-8">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                type="button"
                className="py-2 px-4 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 text-sm font-medium flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-200"
              >
                Google
              </button>
