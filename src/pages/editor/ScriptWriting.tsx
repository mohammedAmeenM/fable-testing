...
const ScriptWriting:React.FC = () => {
      ...
      const handleKeyDown = (event:any, sceneIndex:any, contentIndex:any) => {
        ...
        console.log(allInputRefs,'11111111111111111111111111')
          ...
          const currentInputKey:any = allInputRefs.find(
          ...
          // Update scenes state
          setScenes((prevScenes:any) => {
            const newScenes = prevScenes.map((scene:any, idx:any) => {
              if (idx === sceneIndex) {
                const newContent = scene.content.filter((_:any, i:any) => i !== contentIndex);
            ...
            // Remove empty scenes
            return newScenes.filter((scene:any) => scene.content.length > 0);
          });
